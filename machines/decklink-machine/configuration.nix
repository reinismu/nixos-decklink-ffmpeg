...

{
  ...
  networking.hostName = "decklink-machine"; # Define your hostname.
  ...
  users.users.decklink = {
    isNormalUser = true;
    description = "Decklink";
    extraGroups = [ "networkmanager" "wheel" "audio" ];
  };
  nix.settings.trusted-users = [ "decklink" ];

  # Enable automatic login for the user.
  services.xserver.displayManager.autoLogin.enable = true;
  services.xserver.displayManager.autoLogin.user = "decklink";
